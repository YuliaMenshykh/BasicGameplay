...
#define DRAW_SPHERE_COLOR(Location,Color)if (GetWorld()) DrawDebugSphere(GetWorld(),Location,10.f,12,Color, false, 5.0f);
...
#define DRAW_CUBE(Location) if(GetWorld()) DrawDebugBox(GetWorld(), Location, FVector(100, 100, 100), FColor::Cyan, true, -1.f, 0, 1.0f);

#define DRAW_CUBE_SingleFrame(Location) if(GetWorld()) DrawDebugBox(GetWorld(), Location, FVector(100, 100, 100), FColor::Cyan, false, -1.f, 0, 1.0f);
